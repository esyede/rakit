...
-   [Routing](/docs/routing) <!-- has-submenu -->
    ...
    -   [URI Wildcards](/docs/routing#route-parameters)
    -   [404 Handler](/docs/routing#404-handler)
    -   [Middleware](/docs/routing#middleware)
    -   [Pattern Middleware](/docs/routing#middleware-pattern)
    ...
    -   [Package Routing](/docs/routing#route-for-package)
...
-   [Controllers](/docs/controllers) <!-- has-submenu -->
    ...
    -   [Package Controllers](/docs/controllers#package-controller)
    -   [Action Middleware](/docs/controllers#controller-middleware)
    -   [Nested Controllers](/docs/controllers#nested-controller)
    -   [RESTful Controllers](/docs/controllers#restful-controller)
...
-   [Views & Responses](/docs/views) <!-- has-submenu -->
    ...
    -   [Binding Data to Views](/docs/views#passing-data-to-view)
    -   [Nested Views](/docs/views#nested-views)
    -   [Named Views](/docs/views#named-views)
    -   [View Composers](/docs/views#view-composers)
    -   [Redirects](/docs/views#redirect-responses)
    -   [Redirects with Flash Data](/docs/views#redirect-with-flash-data)
    -   [Download Responses](/docs/views#download-response)
    -   [Error Responses](/docs/views#error-response)
    -   [Templating](/docs/views/templating)
    -   [Data Pagination](/docs/views/pagination)
-   [Input & Cookies](/docs/input) <!-- has-submenu -->
    -   [Input](/docs/input#retrieving-input)
    -   [Files](/docs/input#file-upload)
