        ...
        <div class="content has-text-centered">
            <p>
                {!! trans('docs::docs.footer.credit', [
                    ...
                    'contributors' => '<a href="https://github.com/esyede/rakit/contributors" target="_blank">'.trans('docs::docs.footer.contributors').'</a>',
                    'license' => '<a href="http://opensource.org/licenses/mit-license.php" target="_blank">'.trans('docs::docs.footer.license').'</a>',
                ]) !!}
            </p>
        </div>
