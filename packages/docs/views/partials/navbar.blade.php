    ...
    <div class="container">
        ...
        <div id="navMenuMore" class="navbar-menu">
            ...
            <div class="navbar-end">
                ...
                <a class="navbar-item" id="docs" href="{{ URL::to('docs/'.config('application.language')) }}">Dokumentasi</a>
                <a class="navbar-item" id="api" href="https://rakit.esyede.my.id/api/{{ RAKIT_VERSION }}/index.html" target="_blank">API</a>
