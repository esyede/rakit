...
<div class="column is-9-desktop is-9-tablet">
    <div class="container">
        <div class="is-pulled-right is-hidden-mobile">
            <a href="https://github.com/esyede/rakit/edit/master/packages/docs/data/<?php echo e($filename);?>.md" class="button is-link is-light is-small is-rounded" target="_blank">
                <span class="icon">
...
<?php echo view('docs::layout')->with(get_defined_vars())->render();?>
