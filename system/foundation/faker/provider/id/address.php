...
use System\Foundation\Faker\Provider\Address as BaseAddress;
...
class Address extends BaseAddress
{
    ...
    protected static $stateAbbr = [
        ...
        'Kalbar', 'Kalteng', 'Kalsel', 'Kaltim', 'Kalut', 'Sulsel', 'Sulut', 'Gorontalo',
    ...
    protected static $country = [
        ...
        'Australia', 'Austria', 'Azerbaijan', 'Bahama', 'Bahrain', 'Bangladesh', 'Barbados', 'Belanda',
        'Belarus', 'Belgia', 'Belize', 'Benin', 'Bermuda', 'Bhutan', 'Bolivia', 'Bosnia dan Herzegovina',
        'Botswana', 'Brasil', 'Brunei Darussalam', 'Bulgaria', 'Burkina Faso', 'Burundi', 'Chili', 'Cina',
        'Cocos (Keeling)', 'Denmark', 'Djibouti', 'Dominika', 'Ekuador', 'El Salvador', 'Eritrea', 'Estonia',
        'Ethiopia', 'Federasi Rusia', 'Fiji', 'Filipina', 'Finlandia', 'Gabon', 'Gambia', 'Georgia',
        'Georgia Selatan dan Kepulauan Sandwich Selatan', 'Ghana', 'Gibraltar', 'Greenland', 'Grenada',
        'Guadeloupe', 'Guam', 'Guatemala', 'Guernsey', 'Guinea', 'Guinea Ekuatorial', 'Guinea-Bissau',
        'Guyana', 'Guyana Prancis', 'Haiti', 'Honduras', 'Hong Kong', 'Hongaria', 'India', 'Indonesia',
        'Inggris Raya', 'Irak', 'Iran', 'Irlandia', 'Islandia', 'Israel', 'Italia', 'Jamaika', 'Jepang',
        'Jerman', 'Jersey', 'Jordan', 'Kaledonia baru', 'Kamboja', 'Kamerun', 'Kanada', 'Kazakhstan',
        'Kenya', 'Kepulauan Cayman', 'Kepulauan Cook', 'Kepulauan Falkland (Malvinas)', 'Kepulauan Faroe',
        'Kepulauan Mariana Utara', 'Kepulauan Marshall', 'Kepulauan Pitcairn',
        'Kepulauan Solomon', 'Kepulauan Terluar Kecil Amerika Serikat', 'Kepulauan Turks dan Caicos',
        'Kepulauan Virgin Amerika Serikat', 'Kepulauan Virgin Inggris', 'Kiribati', 'Kolombia', 'Komoro',
        'Kongo', 'Korea', 'Korea', 'Kosta Rika', 'Kroasia', 'Kuba', 'Kuwait', 'Latvia', 'Lebanon', 'Lesotho',
        'Liberia', 'Libyan Arab Jamahiriya', 'Liechtenstein', 'Lithuania', 'Luxembourg', 'Madagaskar', 'Makau',
        'Makedonia', 'Maladewa', 'Malawi', 'Malaysia', 'Mali', 'Malta', 'Maroko', 'Martinik', 'Mauritania',
        'Mauritius', 'Mayotte', 'Meksiko', 'Mesir', 'Mikronesia', 'Moldova', 'Monako', 'Mongolia', 'Montenegro',
        'Montserrat', 'Mozambik', 'Myanmar', 'Namibia', 'Nauru', 'Nepal', 'Niger', 'Nigeria', 'Nikaragua', 'Niue',
        'Norwegia', 'Oman', 'Pakistan', 'Palau', 'Panama', 'Pantai Gading', 'Papua Nugini', 'Paraguay', 'Peru',
        'Polandia', 'Polinesia Prancis', 'Portugal', 'Prancis', 'Puerto Rico', 'Pulau Bouvet',
        'Pulau Heard dan Kepulauan McDonald', 'Pulau Man', 'Pulau Natal', 'Pulau Norfolk', 'Qatar',
        'Republik Afrika Tengah', 'Republik Ceko', 'Republik Chad', 'Republik Demokratik Rakyat Laos',
        'Republik Dominika', 'Republik Kirgizstan', 'Réunion', 'Rumania', 'Rwanda', 'Sahara Barat',
        'Saint Barthelemy', 'Saint Helena', 'Saint Kitts dan Nevis', 'Saint Lucia', 'Saint Martin',
        'Saint Pierre dan Miquelon', 'Saint Vincent dan Grenadines', 'Samoa', 'Samoa Amerika', 'San Marino',
        'Sao Tome dan Principe', 'Selandia baru', 'Senegal', 'Serbia', 'Seychelles', 'Sierra Leone', 'Singapura',
        'Siprus', 'Slovakia (Republik Slovak)', 'Slovenia', 'Somalia', 'Spanyol', 'Sri Lanka', 'Sudan', 'Suriah',
        'Suriname', 'Svalbard & Jan Mayen Islands', 'Swaziland', 'Swedia', 'Swiss', 'Taiwan', 'Tajikistan', 'Tanjung Verde',
        'Tanzania', 'Thailand', 'Timor-Leste', 'Togo', 'Tokelau', 'Tonga', 'Trinidad dan Tobago', 'Tunisia', 'Turki',
        'Turkmenistan', 'Tuvalu', 'Uganda', 'Ukraina', 'Uni Emirat Arab', 'Uruguay', 'Uzbekistan', 'Vanuatu', 'Vatikan',
        'Venezuela', 'Vietnam', 'Wallis dan Futuna', 'Wilayah Palestina', 'Wilayah Samudra Hindia Britania',
    ...
    protected static $cityNames = [
        ...
        'Bandar Lampung', 'Bandung', 'Banjar', 'Banjarbaru', 'Banjarmasin', 'Batam', 'Batu', 'Bau-Bau',
        'Bekasi', 'Bengkulu', 'Bima', 'Binjai', 'Bitung', 'Blitar', 'Bogor', 'Bontang', 'Bukittinggi',
        'Cilegon', 'Cimahi', 'Cirebon', 'Denpasar', 'Depok', 'Dumai', 'Gorontalo', 'Gunungsitoli',
        ...
        'Metro', 'Mojokerto', 'Padang', 'Padangpanjang', 'Padangsidempuan', 'Pagar Alam', 'Palangka Raya',
        'Palembang', 'Palopo', 'Palu', 'Pangkal Pinang', 'Parepare', 'Pariaman', 'Pasuruan', 'Payakumbuh',
        'Pekalongan', 'Pekanbaru', 'Pematangsiantar', 'Pontianak', 'Prabumulih', 'Probolinggo', 'Sabang',
        'Salatiga', 'Samarinda', 'Sawahlunto', 'Semarang', 'Serang', 'Sibolga', 'Singkawang', 'Solok',
        'Sorong', 'Subulussalam', 'Sukabumi', 'Sungai Penuh', 'Surabaya', 'Surakarta', 'Tangerang',
        'Tangerang Selatan', 'Tanjung Pinang', 'Tanjungbalai', 'Tarakan', 'Tasikmalaya', 'Tebing Tinggi',
