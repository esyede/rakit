...
class Responder
{
     ...
     * <code>
     *
     *     return Responder::create($body, 200)->setSharedMaxAge(300);
     *
     * </code>
     *
     * @param string $content
     ...
     * @return Responder
     */
    public function prepare(Requester $request)
    {
    ...
    public function send()
    {
        ...
        if (function_exists('fastcgi_finish_request')) {
            ...
            while (($level = ob_get_level()) > 0 && $level !== $previous) {
                ...
                if (isset($obStatus[$level - 1])
                && isset($obStatus[$level - 1]['del'])
                && $obStatus[$level - 1]['del']) {
                    ob_end_flush();
                }
            }
