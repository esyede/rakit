    ...
    <div class="stage">
        <div class="frame">
            ...
            <div class="hero">
                ...
                <span class="fig">fig. 503</span>
            </div>

            <div class="rule"></div>

            <p class="label">Error &mdash; 503</p>

            <div class="body">
                <strong>Service Unavailable</strong> &mdash; the service is temporarily out. It should be back shortly.
            </div>
