    ...
    <div class="stage">
        <div class="frame">
            ...
            <div class="hero">
                ...
                <span class="fig">fig. 500</span>
            </div>

            <div class="rule"></div>

            <p class="label">Error &mdash; 500</p>

            <div class="body">
                <strong>Internal Server Error</strong> &mdash; something broke on this side while handling the request.
            </div>
