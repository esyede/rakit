        ...
        <div class="frame">
            ...
            <div class="hero">
                <div class="hero-inner">
                    <h1 class="code">401</h1>
                </div>
                <span class="fig">fig. 401</span>
            </div>

            <div class="rule"></div>

            <p class="label">Error &mdash; 401</p>

            <div class="body">
                <strong>Unauthorized</strong> &mdash; you need to sign in before this page can be shown.
            </div>
