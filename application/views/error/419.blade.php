        ...
        <div class="frame">
            ...
            <div class="hero">
                <div class="hero-inner">
                    <h1 class="code">419</h1>
                </div>
                <span class="fig">fig. 419</span>
            </div>

            <div class="rule"></div>

            <p class="label">Error &mdash; 419</p>

            <div class="body">
                <strong>Page Expired</strong> &mdash; the session behind that form expired. Reload the page and send it again.
            </div>
