...
class HttpRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $this->assertEquals('http://hostname:8080/index.php/path/info?query=string', $request->getUri());
        ...
        $request->initialize([], [], [], [], [], $server);
        $this->assertEquals('http://hostname/index.php/path/info?query=string', $request->getUri());
        ...
        $request->initialize([], [], [], [], [], $server);
        $this->assertEquals('http://hostname:8080/path/info?query=string', $request->getUri());
        ...
        $request->initialize([], [], [], [], [], $server);
        $this->assertEquals('http://hostname/path/info?query=string', $request->getUri());
    ...
    public function testGetUriForPath()
    {
        ...
        $request->initialize([], [], [], [], [], $server);
        $this->assertEquals('http://hostname/index.php/some/path', $request->getUriForPath('/some/path'));
        ...
        $request->initialize([], [], [], [], [], $server);
        $this->assertEquals('http://hostname:8080/some/path', $request->getUriForPath('/some/path'));
        ...
        $request->initialize([], [], [], [], [], $server);
        $this->assertEquals('http://hostname/some/path', $request->getUriForPath('/some/path'));
    ...
    public function testGetHost()
    {
        ...
        $this->assertEquals('www.exemple.com', $request->getHost());
    ...
    public function testCreateFromGlobals($method)
    {
        ...
        $this->assertEquals('bar3', $request->cookies->get('foo3'));
        $this->assertEquals(['bar4'], $request->files->get('foo4'));
        $this->assertEquals('bar5', $request->server->get('foo5'));
    ...
    public function testGetLanguages()
    {
        ...
        $this->assertEquals(['zh', 'en', 'en_US'], $request->getLanguages());
        ...
        $this->assertEquals(['en', 'zh', 'en_US'], $request->getLanguages());
